  ...
  const processFile = async (file: File) => {
    try {
      ...
      console.log('PDF parsing successful:', {
        totalSlides: parseResult.metadata.totalSlides,
      ...
      setUploadProgress({
        stage: 'complete',
        progress: 100,
        message: `Analysis complete! Found ${parseResult.metadata.totalSlides} slides with ${parseResult.metadata.confidence}% confidence.`
      });
